...
@available(iOS 13.0, *)
public class MTTRegisterViewController: UIViewController {
    ...
    private func setupSubviews() -> Void {
        ...
        /// 选择地区图标
        let areaIcon: UIImageView = UIImageView(image: UIImage.bundledImage("location_placeholder_icon"))
        ...
        /// 选择地区下拉按钮
        let areaDowndrop: UIImageView = UIImageView(image: UIImage.bundledImage("register_dropdown"))
        ...
        agreeIconButton.setImage(UIImage.bundledImage("agree_normal_icon"), for: .normal)
    ...
    @objc func agreeIconButtonAction(_ button: UIButton) -> Void {
        ...
        button.setImage(UIImage.bundledImage(button.isSelected ? "agree_selected_icon" :"agree_normal_icon" ), for: .normal)
    }
