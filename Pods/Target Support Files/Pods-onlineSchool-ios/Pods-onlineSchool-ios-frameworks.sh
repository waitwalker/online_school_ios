...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ExtensionLibrary/ExtensionLibrary.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WebviewLibrary/WebviewLibrary.framework"
